...
class Facebook extends React.Component {
    ...
    render() {
        return (
            <a onClick={this.handleClick.bind(this)} className="btn color-1 size-1 hover-1" ><i className="fa fa-facebook" />sign up via facebook</a>
            /*<FacebookLogin
                appId="212346185915988"
                autoLoad={false}
...
export default connect(state => ({ isAuthen: state.isAuthen }))(Facebook)

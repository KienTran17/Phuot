                        ...
                        <div className="col-md-10 col-md-push-1 col-lg-8 col-lg-push-2 large-popup-content">
                            <div className="row">
                                ...
                                <form onSubmit={this.onSubmit.bind(this)} className="popup-input-search">
                                    ...
                                    <div className="col-md-6">
                                        <input ref="txtUsername" className="input-signtype" type="text" required placeholder="Age" />
                                    </div>
                                    <div className="col-md-6">
                                        <input ref="txtEmail" className="input-signtype" type="text" required placeholder="Email" />
                                    </div>
                                    <div className="col-md-6">
                                        <input ref="txtPassword" className="input-signtype" type="text" required placeholder="Password" />
                                    </div>
                                    <div className="col-md-6">
                                        <input ref="txtRepeatPassword" className="input-signtype" type="text" required placeholder="Repeat Password" />
                                    </div>
                                    <div className="col-md-6">

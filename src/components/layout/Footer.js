                        ...
                        <div className="row">
                                    ...
                                    <div className="row footer-list-footer">
                                        <div className="col-md-6">
                                            <ul className="link-list">
                                                <li><a href="blog-detail-2.html">About Us</a></li>
                                                <li><a href="blog-detail-2.html">Help</a></li>
                                                <li><a href="blog-detail-2.html">Contacts</a></li>
                            ...
                            <div className="col-md-3 galerry">
                                <div className="footer-block">
                                    ...
                                    <a href="blog-detail-2.html"><img src="../asset/img/g6.jpg" alt /></a>
                                    <a href="blog-detail-2.html"><img src="../asset/img/g7.jpg" alt /></a>
                                    <a href="blog-detail-2.html"><img src="../asset/img/g8.jpg" alt /></a>
                                    <a href="blog-detail-2.html"><img src="../asset/img/g9.jpg" alt /></a>
                                    <a href="blog-detail-2.html"><img src="../asset/img/g10.jpg" alt /></a>
                                    <a href="blog-detail-2.html"><img src="../asset/img/g11.jpg" alt /></a>
                                    <a href="blog-detail-2.html"><img src="../asset/img/g12.jpg" alt /></a>
                                </div>
                            </div>
                                ...
                                <div className="footer-block">
                                    ...
                                    <div className="soc-activity">
                                        ...
                                        <div className="message-soc">
                                            ...
                                            <a href="blog-detail-2.html" className="account">@faq</a> vestibulum accumsan est <a href="blog-detail-2.html" className="heshtag">blog-detail-2.htmlmalesuada</a> sem auctor, eu aliquet nisi ornare leo sit amet varius egestas.
                    </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="footer-bottom">
                    <div className="container-fluid custom-container">
                        <div className="col-md-12 footer-end clearfix">
                            <div className="left">
                                <span className="copy">© 2015. All rights reserved. <span className="white"><a href="blog-detail-2.html"> NRGNetwork</a></span></span>
                                <span className="created">Created with LOVE by <span className="white"><a href="blog-detail-2.html"> NRGThemes</a></span></span>
                            </div>
                            <div className="right">
